...
if __name__ == "__main__":
    solution = Solution()
    print(solution.searchInsert([1, 3, 5, 6], 5))  # 2 (5 находится на индексе 2).
    print(solution.searchInsert([1, 3, 5, 6], 2))  # 1 (2 должно стоять между 1 и 3, поэтому индекс вставки = 1).
    print(solution.searchInsert([1, 3, 5, 6], 7))  # 4 (7 больше всех, поэтому вставляется в самй конец, на индекс 4).
    print(solution.searchInsert([1, 3, 5, 6], 0))  # 0 (0 меньше всех, поэтому вставляется в самое начало, на индекс 0).
